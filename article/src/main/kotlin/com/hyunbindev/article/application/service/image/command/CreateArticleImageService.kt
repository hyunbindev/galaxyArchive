...
internal class CreateArticleImageService(
    ...
    fun upLoadArticleImage(userId: UUID, request: ArticleImageDto.ImageUploadRequest, imageByteStream: InputStream):String {
        ...
        return try{
            val rawKey:String = articleImageUpload.uploadImage(request.originalName, request.contentType, imageByteStream)
